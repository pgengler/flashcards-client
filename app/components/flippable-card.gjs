...
export default class FlippableCard extends Component {<template><div class="flip-container {{if this.isFlipped "flipped"}}" role="button" {{on "click" this.flipCard}} {{onKey "Space" this.flipCard}} ...attributes>
  <div class="flipper">
